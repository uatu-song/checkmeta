...
###############################
"""
Convergence mechanics for META League Simulator
"""
...
from ..config.game_config import MAX_CONVERGENCES_PER_CHAR
...
class ConvergenceSystem:
    ...
    def process_convergences(self, team_a: Team, team_a_boards: List[chess.Board], 
        ...
        max_convergences_per_char = MAX_CONVERGENCES_PER_CHAR
